...
- Use GitNexus to understand the code and its dependencies (see below)

<!-- gitnexus:start -->
# GitNexus — Code Intelligence

This project is indexed by GitNexus as **actions** (78 symbols, 185 relationships, 13 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/actions/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/actions/context` | Codebase overview, check index freshness |
| `gitnexus://repo/actions/clusters` | All functional areas |
| `gitnexus://repo/actions/processes` | All execution flows |
| `gitnexus://repo/actions/process/{name}` | Step-by-step execution trace |
